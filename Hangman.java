...
public class Hangman extends ConsoleProgram {
	...
	/**
	 * Adds hyphens to String result for each char in argument String str.
	...
	/**
	 * Returns true if argument char is contained within String word. If true,
	 * adds the positions where that char appears within the String word to
	 * ArrayList index.
	 * 
	 * @param ch
	 * @return
	...
	/**
	 * Updates the string displayed on the screen, using the argument char to
	 * display letters that are correctly guessed; unguessed letters remain
	 * hyphens.
	 * 
	 * @param ch
	 */
